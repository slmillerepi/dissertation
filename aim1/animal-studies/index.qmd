...
### mRNA vaccines encoding computationally optimized hemagglutinin elicit protective antibodies against future antigenically drifted H1N1 and H3N2 influenza viruses isolated between 2018-2020 [@allen24] {#sec-allen24}
...
```{r}
knitr::include_graphics(here::here("aim1/animal-studies/allen24-schematic.png"))
```
